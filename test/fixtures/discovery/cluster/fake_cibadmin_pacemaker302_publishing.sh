...
cat <<EOF
<cib crm_feature_set="3.1.0" validate-with="pacemaker-4.0" epoch="6881" num_updates="0" admin_epoch="0" cib-last-written="Mon Nov 18 17:48:21 2019" update-origin="node01" update-client="crm_attribute" update-user="root" have-quorum="1" dc-uuid="1084783375">
  <configuration>
    <crm_config>
    ...
    <resources>
      ...
      <group id="g_ip_PRD_HDB00">
        <primitive id="rsc_ip_PRD_HDB00" class="ocf" provider="heartbeat" type="IPaddr2">
          ...
          <!--######################################-->
          <instance_attributes id="rsc_ip_PRD_HDB00-instance_attributes">
            <nvpair name="ip" value="10.74.1.12" id="rsc_ip_PRD_HDB00-instance_attributes-ip"/>
          </instance_attributes>
        </primitive>
      </group>
    </resources>
