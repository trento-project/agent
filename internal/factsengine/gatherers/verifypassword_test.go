...
func (suite *PasswordTestSuite) TestPasswordGatherEqual() {
	...
	suite.mockExecutor.On("OutputContext", mock.Anything, "/usr/bin/getent", "shadow", "hacluster").Return(
		shadow, nil)
...
func (suite *PasswordTestSuite) TestPasswordGatherBloquedPassword() {
	suite.mockExecutor.
		On("OutputContext", mock.Anything, "/usr/bin/getent", "shadow", "hacluster").
