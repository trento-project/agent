...
func (suite *SapProfilesTestSuite) TestSapProfilesSuccess() {
	...
	defaultProfileConcent, _ := io.ReadAll(defaultProfileFile)
	err := afero.WriteFile(appFS, "/sapmnt/PRD/profile/DEFAULT.PFL", defaultProfileConcent, 0644)
	suite.NoError(err)
