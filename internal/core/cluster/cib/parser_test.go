...
func (suite *ParserTestSuite) TestParse() {
	...
	suite.Len(data.Configuration.Resources.Primitives, 4)
	suite.Len(data.Configuration.Resources.Masters, 1)
	suite.Len(data.Configuration.Resources.Clones, 1)
	...
	suite.Len(data.Configuration.Resources.Primitives[0].InstanceAttributes, 1)
	...
	suite.Len(data.Configuration.Resources.Groups, 1)
	suite.Equal("g_ip_PRD_HDB00", data.Configuration.Resources.Groups[0].ID)
	suite.Len(data.Configuration.Resources.Groups[0].Primitives, 1)
	...
	suite.Len(data.Configuration.Resources.Groups[0].Primitives[0].InstanceAttributes, 1)
	...
	suite.Len(data.Configuration.Resources.Masters[0].MetaAttributes, 3)
	suite.Equal("rsc_SAPHana_PRD_HDB00", data.Configuration.Resources.Masters[0].Primitive.ID)
	suite.Len(data.Configuration.Resources.Masters[0].Primitive.Operations, 5)
