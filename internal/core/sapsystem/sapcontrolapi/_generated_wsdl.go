...
type ABAPSetServerInactive struct {
	XMLName xml.Name `xml:"urn:SAPControl ABAPSetServerInactive"`
...
type ABAPSetServerInactiveResponse struct {
}
...
type SAPControlPortType interface {
	...
	/* Sets ABAP server inactive or active (like sm51 transaction can do). */
	ABAPSetServerInactive(request *ABAPSetServerInactive) (*ABAPSetServerInactiveResponse, error)

	ABAPSetServerInactiveContext(ctx context.Context, request *ABAPSetServerInactive) (*ABAPSetServerInactiveResponse, error)
...
func (service *sAPControlPortType) ABAPSetServerInactiveContext(ctx context.Context, request *ABAPSetServerInactive) (*ABAPSetServerInactiveResponse, error) {
	response := new(ABAPSetServerInactiveResponse)
	err := service.client.CallContext(ctx, "''", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *sAPControlPortType) ABAPSetServerInactive(request *ABAPSetServerInactive) (*ABAPSetServerInactiveResponse, error) {
	return service.ABAPSetServerInactiveContext(
		context.Background(),
		request,
	)
}
