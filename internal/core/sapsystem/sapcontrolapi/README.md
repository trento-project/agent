...
As using all the operations is not intended, a simplified version of it has been extracted into `webservice.go`, with matching tests in `webservice_test.go`.
