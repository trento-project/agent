...
func NewSaptuneDiscovery() Discoverer[SaptuneDiscoveryPayload] {
	return SaptuneDiscovery{}
}

func (d SaptuneDiscovery) Discover(_ context.Context) (SaptuneDiscoveryPayload, string, error) {
	...
	return saptunePayload, "Saptune data discovery completed", nil
}
