...
func TestParse(t *testing.T) {
	...
	assert.Equal(t, 1, len(data.Configuration.Resources.Groups))
	assert.Equal(t, "g_ip_PRD_HDB00", data.Configuration.Resources.Groups[0].ID)
	assert.Equal(t, 1, len(data.Configuration.Resources.Groups[0].Primitives))
	assert.Equal(t, "rsc_ip_PRD_HDB00", data.Configuration.Resources.Groups[0].Primitives[0].ID)
	assert.Equal(t, "ocf", data.Configuration.Resources.Groups[0].Primitives[0].Class)
	assert.Equal(t, "heartbeat", data.Configuration.Resources.Groups[0].Primitives[0].Provider)
	assert.Equal(t, "IPaddr2", data.Configuration.Resources.Groups[0].Primitives[0].Type)
	assert.Equal(t, 1, len(data.Configuration.Resources.Groups[0].Primitives[0].InstanceAttributes))
	assert.Equal(t, "rsc_ip_PRD_HDB00-instance_attributes-ip", data.Configuration.Resources.Groups[0].Primitives[0].InstanceAttributes[0].ID)
	assert.Equal(t, "ip", data.Configuration.Resources.Groups[0].Primitives[0].InstanceAttributes[0].Name)
	assert.Equal(t, "10.74.1.12", data.Configuration.Resources.Groups[0].Primitives[0].InstanceAttributes[0].Value)
