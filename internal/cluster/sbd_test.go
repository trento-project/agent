...
func (suite *SbdTestSuite) TestGetSBDConfig() {
	sbdConfig, err := getSBDConfig("../../test/fixtures/discovery/cluster/sbd/sbd_config")
...
func (suite *SbdTestSuite) TestNewSBD() {
	...
	s, err := NewSBD(mockCommand, "mycluster", "/bin/sbd", "../../test/fixtures/discovery/cluster/sbd/sbd_config")
...
func (suite *SbdTestSuite) TestNewSBDError() {
	mockCommand := new(mocks.CommandExecutor)
	s, err := NewSBD(
		mockCommand, "mycluster", "/bin/sbd", "../../test/fixtures/discovery/cluster/sbd/sbd_config_no_device")
...
func (suite *SbdTestSuite) TestNewSBDQuotedDevices() {
	...
	s, err := NewSBD(
		mockCommand, "mycluster", "/bin/sbd", "../../test/fixtures/discovery/cluster/sbd/sbd_config_quoted_devices")
