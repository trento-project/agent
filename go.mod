...
require (
	...
	github.com/trento-project/workbench v0.0.0-20241003083824-36efbe7e650b
...
replace github.com/trento-project/contracts/go => ../contracts/go

replace github.com/trento-project/workbench => ../workbench
